...
New-AzResourceGroupDeployment -Name "az-deploy-01" -ResourceGroupName $rg.ResourceGroupName -Location $rg.Location `
    -TemplateFile "https://raw.githubusercontent.com/ameerhamza/lbdsc/master/network.json"  `
    -TemplateParameterFile "https://raw.githubusercontent.com/ameerhamza/lbdsc/master/network.parameters.json"
